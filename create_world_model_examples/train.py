...
def train_agent(env, args, config):
    ...
    for T in range(1, args.T_max + 1):
        ...
        if done:
            ...
            print('\rTime steps {}  episode {} score {} Average Score: {:.2f} steps {} ave steps {:.2f} time: {}'.format(T, episode, score, np.mean(scores_window), steps, ave_steps, time_format(time.time() - t0)), end="")         
